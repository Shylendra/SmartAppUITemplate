...
@Configuration
@Aspect
@ComponentScan({"com.smartapps.smartappui.shared.*",
	"com.smartapps.smartappui.jpa.*",
	"com.smartapps.smartappui.web.*",
	"com.smartapps.smartlib.*"})
@EntityScan("com.smartapps.smartappui.jpa.entities")
@EnableTransactionManagement
@EnableJpaRepositories(basePackages = { "com.smartapps.smartappui.jpa.repository" })
